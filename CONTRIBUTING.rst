...
SEAMM Util could always use more documentation, whether as part of the
official SEAMM Util docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `seamm_util` repo on GitHub.
...
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4 and 3.5, and for PyPy. Check
   https://travis-ci.org/molssi-seamm/seamm_util/pull_requests
