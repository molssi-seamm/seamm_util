...
def test_open_2files():
    ...
    filepath = datapath / "file_middle.txt"
    data = [
        "file_middle line 1",
        "file_middle line 2",
        "file1 line 1",
...
def test_open_2files_at_end():
    ...
    filepath = datapath / "file_end.txt"
    data = [
        "file_end line 1",
        "file_end line 2",
        "file_end line 3",
...
def test_nested_includes():
    ...
    filepath = datapath / "file_include1.txt"
    data = [
        "file_include1 line1",
        "file_end line 1",
        "file_end line 2",
    ...
    with seamm_util.Open(filepath, "r", include="include") as fd:
        for line in fd:
            assert line.strip() == data[i]
            i += 1
        tmp = [path[1].name for path in fd.visited]
    assert tmp == visited


def test_include_empty_file():
    """Testing that including an empty file works"""
    filepath = datapath / "include_empty_file.txt"
...
def test_blank_lines():
    ...
    cause any problems
    """
    filepath = datapath / "include_blank_lines.txt"
    data = [
        "file_end line 1",
        "",
        "file_end line 3",
...
def test_different_include():
    ...
    filepath = datapath / "file_#include.txt"
    data = [
        "file_middle line 1",
        "file_middle line 2",
        "file1 line 1",
