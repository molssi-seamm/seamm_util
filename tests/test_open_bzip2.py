...
def test_open_1file():
    ...
    filepath = datapath / "file1.txt.bz2"
...
def test_open_2files():
    ...
    filepath = datapath / "file_middle.txt.bz2"
    data = [
        "file_middle line 1",
        "file_middle line 2",
        "file1 line 1",
...
def test_open_uri():
    """Testing that the default 'include' works"""
    filepath = "data:file_uri.txt.bz2"
    data = [
        "file_uri line 1",
        "file_uri line 2",
        "file1 line 1",
...
def test_open_2files_at_end():
    ...
    filepath = datapath / "file_end.txt.bz2"
    data = [
        "file_end line 1",
        "file_end line 2",
        "file_end line 3",
...
def test_nested_includes():
    ...
    filepath = datapath / "file_include1.txt.bz2"
    data = [
        "file_include1 line1",
        "file_end line 1",
        "file_end line 2",
...
def test_include_empty_file():
    ...
    filepath = datapath / "include_empty_file.txt.bz2"
...
def test_blank_lines():
    ...
    cause any problems
    """
    filepath = datapath / "include_blank_lines.txt.bz2"
    data = [
        "file_end line 1",
        "",
        "file_end line 3",
...
def test_stack():
    ...
    filepath = datapath / "file_include1.txt.bz2"
    data = [
        "data/file1.txt.bz2:2",
        "data/file_end.txt.bz2:4",
        "data/file_include1.txt.bz2:2",
    ]
...
def test_different_include():
    ...
    filepath = datapath / "file_#include.txt.bz2"
    data = [
        "file_middle line 1",
        "file_middle line 2",
        "file1 line 1",
