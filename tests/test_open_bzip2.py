...
def test_open_1file():
    ...
    filepath = os.path.join(datapath, 'file1.txt.bz2')
...
def test_open_2files():
    ...
    """
    datapath = os.path.join(os.path.dirname(__file__), 'data')
    filepath = os.path.join(datapath, 'file_middle.txt.bz2')
    data = [
...
def test_open_2files_at_end():
    ...
    """
    datapath = os.path.join(os.path.dirname(__file__), 'data')
    filepath = os.path.join(datapath, 'file_end.txt.bz2')
    data = [
...
def test_include_empty_file():
    ...
    """
    datapath = os.path.join(os.path.dirname(__file__), 'data')
    filepath = os.path.join(datapath, 'include_empty_file.txt.bz2')
...
def test_blank_lines():
    ...
    """
    datapath = os.path.join(os.path.dirname(__file__), 'data')
    filepath = os.path.join(datapath, 'include_blank_lines.txt.bz2')
    data = [
...
def test_different_include():
    ...
    """
    datapath = os.path.join(os.path.dirname(__file__), 'data')
    filepath = os.path.join(datapath, 'file_#include.txt.bz2')
    data = [
        'file_middle line 1', 'file_middle line 2', 'file1 line 1',
        'file1 line 2', 'file1 line 3', 'file1 line 4', 'file_middle line 3'
    ]
